                ...
                <Card.Body data-aos="fade-in">
                    ...
                    <Form style={{width : '20vw', minWidth: '250px'}} >
                        ...
                        <Form.Group>
                            ...
                            <Form.Text className="text-black-50">Enter the email you created your account with</Form.Text>
                        </Form.Group>
                        <Form.Group>
                            <Form.Label>Password:</Form.Label>
                        ...
                        <Form.Group>
                            <Button variant="primary">Login</Button>
                            <Form.Text><Link to="/register" style={{color : 'inherit' }}>Don't have an account?</Link></Form.Text>
                        </Form.Group>
                    </Form>
                </Card.Body>
            </Card>
